...
bot = TeleBot(token='5482550126:AAFT2Fmrgm_YiJNfMgi5eqg9WRcvJc7DEWw', parse_mode='html') # создание бота
...
def start_command_handler(message: types.Message):
    # отправляем ответ на команду '/start'
       bot.send_message(
        ...
        text='Привет! Я умею генерировать номер тестовой банковской карты. Попробуем?\nВыбирай тип карты:', # текст сообщения
